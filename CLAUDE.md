...
coexistent : **v1** et **v2** sont des batailles tactiques, gelées ; **w7** est
...
Les six du monde sont dans `docs/spec/world-w7.md`. Les deux qui se cassent le
plus facilement :
...
| | |
| --- | --- |
| les règles et les six invariants | `docs/spec/world-w7.md` |
